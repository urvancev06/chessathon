...
| pruning-vs-no-pruning-isolated | . | /home/lkmsdx/dev/ct-prepruning | 10+0.1 s | 300 | +120 =42 -138 | 47.0% | ±5.2% | -21 (-58 to +16) | 14.0% | checkmate 258, threefold_repetition 24, insufficient_material 15, stalemate 2, fifty_moves 1 | 12 | 0.09 3.18 7.54 / 9.09 11.48 11.70 | data/openings.txt |
| rfp-plus-futility-no-lmp-vs-no-pruning | /home/lkmsdx/dev/ct-nolmp | /home/lkmsdx/dev/ct-prepruning | 10+0.1 s | 300 | +132 =49 -119 | 52.2% | ±5.2% | +15 (-21 to +51) | 16.3% | checkmate 251, threefold_repetition 25, insufficient_material 23, fifty_moves 1 | 12 | 0.06 1.40 5.88 / 9.16 11.60 11.73 | data/openings.txt |
...
| SEE + one-ply continuation history vs v1.2, real clock, 1000 games | /tmp/claude-1000/-home-lkmsdx-dev-chessathon/7dd4cbd4-f467-4fd3-8ea7-925985a11a73/scratchpad/agent-ct-ordering | versions/v1.2 | 120+0.5 s | 1000 | +357 =388 -255 | 55.1% | ±2.4% | +36 (+19 to +53) | 38.8% | checkmate 612, threefold_repetition 283, insufficient_material 70, fifty_moves 35 | 12 | 0.80 3.50 7.95 / 4.37 8.91 10.93 | data/openings.txt |
...
| CALIBRATION: v1.3 full clock vs v1.3 half clock -- Elo per doubling | versions/v1.3 | /tmp/claude-1000/-home-lkmsdx-dev-chessathon/86bc896e-b196-4c75-b662-f07d452f72d8/scratchpad/half | 120+0.5 s | 300 | +142 =102 -56 | 64.3% | ±4.3% | +102 (+71 to +136) | 34.0% | checkmate 198, threefold_repetition 74, fifty_moves 14, insufficient_material 13, stalemate 1 | 12 | 0.12 0.14 0.10 / 1.39 6.09 9.66 | data/openings.txt |
| transposition bundle vs v1.3: qTT + 2^23 + aspiration 20 + history malus | /tmp/claude-1000/-home-lkmsdx-dev-chessathon/86bc896e-b196-4c75-b662-f07d452f72d8/scratchpad/bundle | versions/v1.3 | 120+0.5 s | 300 | +116 =104 -80 | 56.0% | ±4.5% | +42 (+10 to +74) | 34.7% | checkmate 196, threefold_repetition 76, insufficient_material 19, fifty_moves 9 | 8 | 0.74 0.63 0.47 / 2.38 5.13 6.89 | data/openings.txt |
