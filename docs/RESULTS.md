...
| v1.2-pruning-vs-v1.1-screen | . | versions/v1.1 | 10+0.1 s | 300 | +135 =42 -123 | 52.0% | ±5.3% | +14 (-23 to +51) | 14.0% | checkmate 258, insufficient_material 18, threefold_repetition 24 | 12 | 0.98 1.55 2.26 / 8.68 11.37 11.39 | data/openings.txt |
| pruning-vs-no-pruning-isolated | . | (worktree) ct-prepruning | 10+0.1 s | 300 | +120 =42 -138 | 47.0% | ±5.2% | -21 (-58 to +16) | 14.0% | checkmate 258, threefold_repetition 24, insufficient_material 15, stalemate 2, fifty_moves 1 | 12 | 0.09 3.18 7.54 / 9.09 11.48 11.70 | data/openings.txt |
| rfp-plus-futility-no-lmp-vs-no-pruning | (worktree) ct-nolmp | (worktree) ct-prepruning | 10+0.1 s | 300 | +132 =49 -119 | 52.2% | ±5.2% | +15 (-21 to +51) | 16.3% | checkmate 251, threefold_repetition 25, insufficient_material 23, fifty_moves 1 | 12 | 0.06 1.40 5.88 / 9.16 11.60 11.73 | data/openings.txt |
| fuzz-random v1.2 frozen | versions/v1.2 | baselines/random | 3+0.05 s | 300 | +300 =0 -0 | 100.0% | ±0.0% | - | 0.0% | checkmate 300 | 6 | 11.72 9.73 5.07 / 5.42 7.23 8.95 | data/openings.txt |
| fuzz-greedy v1.2 frozen | versions/v1.2 | baselines/greedy | 10+0.1 s | 200 | +200 =0 -0 | 100.0% | ±0.0% | - | 0.0% | checkmate 200 | 6 | 1.31 2.24 5.65 / 4.96 6.35 6.54 | data/openings.txt |
| SEE + one-ply continuation history vs v1.2, real clock, 1000 games | (scratch build) agent-ct-ordering | versions/v1.2 | 120+0.5 s | 1000 | +357 =388 -255 | 55.1% | ±2.4% | +36 (+19 to +53) | 38.8% | checkmate 612, threefold_repetition 283, insufficient_material 70, fifty_moves 35 | 12 | 0.80 3.50 7.95 / 4.37 8.91 10.93 | data/openings.txt |
| fuzz-random v1.3 frozen | versions/v1.3 | baselines/random | 3+0.05 s | 300 | +300 =0 -0 | 100.0% | ±0.0% | - | 0.0% | checkmate 300 | 6 | 0.73 1.92 6.03 / 4.96 5.88 6.09 | data/openings.txt |
| fuzz-greedy v1.3 frozen | versions/v1.3 | baselines/greedy | 10+0.1 s | 200 | +200 =0 -0 | 100.0% | ±0.0% | - | 0.0% | checkmate 200 | 6 | 4.96 5.88 6.09 / 5.07 5.90 6.08 | data/openings.txt |
| CALIBRATION: v1.3 full clock vs v1.3 half clock -- Elo per doubling | versions/v1.3 | (scratch build) half | 120+0.5 s | 300 | +142 =102 -56 | 64.3% | ±4.3% | +102 (+71 to +136) | 34.0% | checkmate 198, threefold_repetition 74, fifty_moves 14, insufficient_material 13, stalemate 1 | 12 | 0.12 0.14 0.10 / 1.39 6.09 9.66 | data/openings.txt |
| transposition bundle vs v1.3: qTT + 2^23 + aspiration 20 + history malus | (scratch build) bundle | versions/v1.3 | 120+0.5 s | 300 | +116 =104 -80 | 56.0% | ±4.5% | +42 (+10 to +74) | 34.7% | checkmate 196, threefold_repetition 76, insufficient_material 19, fifty_moves 9 | 8 | 0.74 0.63 0.47 / 2.38 5.13 6.89 | data/openings.txt |
| fuzz-random v1.4 frozen | versions/v1.4 | baselines/random | 3+0.05 s | 300 | +300 =0 -0 | 100.0% | ±0.0% | - | 0.0% | checkmate 300 | 6 | 0.78 0.39 1.45 / 5.15 5.92 5.47 | data/openings.txt |
| fuzz-greedy v1.4 frozen | versions/v1.4 | baselines/greedy | 10+0.1 s | 200 | +200 =0 -0 | 100.0% | ±0.0% | - | 0.0% | checkmate 200 | 6 | 5.15 5.92 5.47 / 4.60 5.79 5.91 | data/openings.txt |
| v2.0 bundle vs v1.4 | data/arena/b2build | versions/v1.4 | 10+0.1 s | 400 | +149 =54 -197 | 44.0% | ±4.5% | -42 (-74 to -10) | 13.5% | checkmate 346, threefold_repetition 29, stalemate 2, insufficient_material 23 | 2 | 1.96 2.50 2.31 / 1.51 1.93 2.03 | data/openings.txt |
| six search changes vs v1.4 (king-danger gate reverted) | data/arena/b2build | versions/v1.4 | 10+0.1 s | 400 | +163 =51 -186 | 47.1% | ±4.6% | -20 (-52 to +12) | 12.8% | threefold_repetition 23, insufficient_material 26, checkmate 349, fifty_moves 2 | 3 | 0.68 1.12 1.64 / 2.34 2.87 2.99 | data/openings.txt |
| nnue quiet-filtered w128 vs v1.2, real clock | (worktree) ct-nnue | versions/v1.2 | 120+0.5 s | 300 | +111 =21 -168 | 40.5% | ±5.4% | -67 (-106 to -29) | 7.0% | checkmate 279, insufficient_material 3, threefold_repetition 9, fifty_moves 9 | 12 | 3.97 6.64 7.19 / 1.89 6.98 10.10 | data/openings.txt |

**A note on the last row.** The network screen ran on the `ct-nnue-screen` branch on 9 September and
its row was written there, not here. It reached `main` only during the public-release tidy on
11 September. That is a process failure worth naming: the rule is that every measurement lands in
this file, and the single largest negative result of the week spent two days on a branch where
nobody reading `main` would have found it. Nothing about the number changed in the move.
