...
\textbf{This matters more than it looks.} Our position on the hourly ladder is 104th of 131 ---
but that number decides almost nothing. It affects the first-round pairing on Friday and nothing
else. We joined late, started at a low rating, and have therefore only ever been paired against
weak opponents (our 18 opponents average well below the field median; we have never played a
top-50 team). \textbf{Thirteen games on Friday decide everything.}
