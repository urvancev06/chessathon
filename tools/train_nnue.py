...
The float model is exactly the integer one in `tools/nnue_model.py`, written so that quantising
...
def main() -> int:
    ...
    parser.add_argument("--out", type=Path, default=ROOT / "data" / "net.npz")
    parser.add_argument(
        "--labels",
        type=Path,
        nargs="*",
